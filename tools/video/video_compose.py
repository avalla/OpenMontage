...
class VideoCompose(BaseTool):
    ...
    def _stage_remotion_media(value: Any, public_dir: Path) -> int:
        ...
        # images[] (anime_scene) and backgroundImage/backgroundVideo also carry
        # local paths staged by earlier pipeline stages.
        media_keys = {"source", "src", "backgroundSrc", "images", "backgroundImage", "backgroundVideo"}
